    ...
    <>
      ...
      <div className="w-[700px] m-auto p-5 max-[800px]:w-full max-[800px]:py-5 max-[800px]:px-10">
        ...
        <p className="font-sans font-medium leading-7 mt-4">
          ...
          algorithms, and data structures, as well as excellent problem-solving
          and analytical skills.
        </p>
        <p className="font-sans font-medium leading-7 mt-4">
          {"I was"} born and brought up in small vilage with all good amenities
          like a town so called Uchkurgan. I have been interested in various
          games since I was young. My interest in gaming motivated me to become
          a programmer. I have studied IT since I was 14 years old and have
          mastered and taught many frameworks and technologies since now.
        </p>
        <p className="font-sans font-medium leading-7 mt-4">
          As a mentor, I teach students how to code front and back side of
          applications. And reviewing codes and helping learners to write better
          and cleaner code. I also participate in Open-Events to share my
          experience with students and making{" "}
          <Link
            className="font-semibold text-[#1877FE]"
        ...
        <p className="font-sans font-medium leading-7 mt-4">
          Thank you for checking and reading all informations carefully. I hope
